                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <Input id="patient-first-name" value={formData.firstName} onChange={e => setFormData({...formData, firstName: e.target.value})} required />
                        </div>
                        <div>
                            <Label htmlFor="patient-last-name">Nazwisko</Label>
                            <Input id="patient-last-name" value={formData.lastName} onChange={e => setFormData({...formData, lastName: e.target.value})} required />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Input id="patient-birth-date" type="date" value={formData.birthDate} onChange={e => setFormData({...formData, birthDate: e.target.value})} />
                        </div>
                    </div>

                    <div>
                         <Label htmlFor="patient-guardian-name">Imię opiekuna (dla dzieci)</Label>
                         <Input id="patient-guardian-name" value={formData.guardianName} onChange={e => setFormData({...formData, guardianName: e.target.value})} />
                    </div>
