                    ...
                    <div className="flex items-center space-x-2 border p-3 rounded bg-slate-50">
                        ...
                        />
                         <Label htmlFor="gdpr" className="text-sm font-normal">
                            Potwierdzam odebranie zgody RODO (z dzisiejszą datą) <span className="text-red-500">*</span>
                        </Label>
                    </div>

                    <Button type="submit" className="w-full" disabled={isPending}>
                        {isPending ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Zapisywanie...</> : "Zapisz"}
                    </Button>
                </form>
            </DialogContent>
        </Dialog>
