                        ...
                        <>
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <button
                                    ...
                                    disabled={isPending}
                                    className="flex items-center space-x-2 border p-1 px-3 rounded h-8 mt-6 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50 transition-colors"
                                    onClick={() => handleQuickUpdate(undefined, !isPaid)}
                                >
                                     <div className={`w-3 h-3 rounded-full ${isPaid ? "bg-green-500" : "bg-red-500"}`} aria-hidden="true" />
                                     <span className="text-sm" aria-hidden="true">{isPaid ? "Opłacona" : "Nieopłacona"}</span>
                                </button>
                            </div>
                        </>
                    )}
