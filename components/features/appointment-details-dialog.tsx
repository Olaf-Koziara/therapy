                    ...
                    {isEditing ? (
                        ...
                        <>
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <button type="button" className="flex items-center space-x-2 border p-1 px-3 rounded h-8 mt-6 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring" onClick={() => handleQuickUpdate(undefined, !isPaid)}>
