                        ...
                        <>
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <button
                                    ...
                                    aria-label={`Status płatności: ${isPaid ? "Opłacona" : "Nieopłacona"}. Kliknij aby zmienić.`}
                                    className="flex items-center space-x-2 border p-1 px-3 rounded h-8 mt-6 cursor-pointer hover:bg-slate-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                                >
                                     <div aria-hidden="true" className={`w-3 h-3 rounded-full ${isPaid ? "bg-green-500" : "bg-red-500"}`} />
                                     <span aria-hidden="true" className="text-sm">{isPaid ? "Opłacona" : "Nieopłacona"}</span>
                                </button>
                            </div>
                        </>
                    )}
