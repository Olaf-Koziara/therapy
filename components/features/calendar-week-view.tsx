                                ...
                                <div key={day.toISOString()} className="border-r last:border-r-0 p-1 relative">
                                    {dayApps.map(app => (
                                        <button
                                            ...
                                            className={cn(
                                                "w-full text-left text-xs p-1 rounded mb-1 border-l-4 truncate cursor-pointer hover:opacity-80 transition-opacity focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none",
                                            ...
                                            aria-label={`Wizyta: ${app.patient.firstName} ${app.patient.lastName}, godzina ${format(app.startDateTime, 'HH:mm')}, status ${app.status}`}
                                        >
