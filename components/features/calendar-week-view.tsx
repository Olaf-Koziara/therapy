                                ...
                                <div key={day.toISOString()} className="border-r last:border-r-0 p-1 relative">
                                    {dayApps.map(app => (
                                        <button
                                            ...
                                            className={cn(
                                                "text-xs p-1 rounded mb-1 border-l-4 truncate cursor-pointer hover:opacity-80 transition-opacity w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
